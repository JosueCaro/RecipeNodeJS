    ...
    async generateRecipe(prompt) {
        const response = await this.openai.createChatCompletion({
            ...
            messages: [
                ...
                - Si no te pasan una lista de ingredientes, vas a contestar
                con { "error": true }.
                ...
                - Si no entiendes lo que te pasen, o no son ingredientes
                  vas a contestar con { "error": true }
                - No es necesario utilizar todos los ingredientes.
                - Siempre incluye los condimentos básicos, como sal, pimienta,
                  azúcar, además de agua.
                ` },
